...
/* Estilos del mockup iPhone (diseño nami_iphone_mockup.html) — scoped */
const mockupStyles = `
...
html.dark .nami-iphone-mockup .search-bar { background: #1a1a1a; box-shadow: 0 4px 20px rgba(0,0,0,.3), 0 0 0 .5px rgba(255,255,255,.06); }
html.dark .nami-iphone-mockup .search-bar span { color: rgba(255,255,255,.3); }
html.dark .nami-iphone-mockup .float { background: #1a1a1a; box-shadow: 0 8px 30px rgba(0,0,0,.4), 0 0 0 .5px rgba(255,255,255,.06); }
html.dark .nami-iphone-mockup .float-text { color: #f0f0f0; }
`;
...
const cards = [
  ...
  { name: "Sabor Criollo", cat: "Comida tipica", rating: "4.6", emoji: "🍲" },
  { name: "Pizza Nova", cat: "Pizzeria", rating: "4.9", emoji: "🍕" },
];
  ...
  return (
    <div className="nami-iphone-mockup relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none" aria-hidden>
        <div className="w-72 h-72 rounded-full bg-gradient-to-br from-nami-orange/20 to-nami-purple/20 blur-[80px]" />
      </div>
      ...
      <div className="scene relative">
        ...
        <div className="float float-2">
          ...
          <span className="float-text">Tú no pagas comisión a ÑAMI</span>
        </div>
        {/* Phone */}
        <div className="phone">
